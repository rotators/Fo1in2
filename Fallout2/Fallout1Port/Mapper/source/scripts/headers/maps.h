...
/*******************************************************************************
          Показывает, открыт ли указанный город на глобальной карте
*******************************************************************************/
...
/*******************************************************************************
                           Пометить город на карте
*******************************************************************************/
/*Внимание! Этот макрос на самом деле сложный, т.е. состоит из нескольких
команд/операций! При использовании после вызова не ставится ; ("точка с запятой")!*/
