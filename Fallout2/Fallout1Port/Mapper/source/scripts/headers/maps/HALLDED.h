...
#define MVAR_Fixt_PLACEHOLDER_0      (13)//   Adding for ass-covering and future-proofing
#define MVAR_Fixt_PLACEHOLDER_1      (14)//   Adding for ass-covering and future-proofing
