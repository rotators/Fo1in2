...
#define AI_PARTY_IAN_AGGRESSIVE		(95)
#define AI_PARTY_IAN_BERSERK		(96)
#define AI_PARTY_IAN_COWARD			(97)
#define AI_PARTY_IAN_CUSTOM			(98)
#define AI_PARTY_IAN_DEFENSIVE		(99)
#define AI_PARTY_TYCHO_AGGRESSIVE	(100)
#define AI_PARTY_TYCHO_BERSERK		(101)
#define AI_PARTY_TYCHO_COWARD		(102)
#define AI_PARTY_TYCHO_CUSTOM		(103)
#define AI_PARTY_TYCHO_DEFENSIVE	(104)
#define AI_KATJA					(105)
#define AI_PARTY_KATJA_AGGRESSIVE	(106)
#define AI_PARTY_KATJA_BERSERK		(107)
#define AI_PARTY_KATJA_COWARD		(108)
#define AI_PARTY_KATJA_CUSTOM		(109)
#define AI_PARTY_KATJA_DEFENSIVE	(110)
#define AI_TANDI					(111)
#define AI_PARTY_TANDI_AGGRESSIVE	(112)
#define AI_PARTY_TANDI_BERSERK		(113)
#define AI_PARTY_TANDI_COWARD		(114)
#define AI_PARTY_TANDI_CUSTOM		(115)
#define AI_PARTY_TANDI_DEFENSIVE	(116)
#define AI_DOGMEAT					(117)
#define AI_PARTY_DOGMEAT_AGGRESSIVE	(118)
#define AI_PARTY_DOGMEAT_BERSERK	(119)
#define AI_PARTY_DOGMEAT_COWARD		(120)
#define AI_PARTY_DOGMEAT_CUSTOM		(121)
#define AI_PARTY_DOGMEAT_DEFENSIVE	(122)
