...
#define give_xp_msg(x, msg2)                    give_exp_points(x); \
                                                display_msg(g_mstr(10) + (x + ((x * (5 * dude_perk(PERK_swift_learner))) / 100)) + msg2)

// Fallout 2
#define give_xp(x)                              give_exp_points(x); \
                                                display_msg(g_mstr(10) + (x + ((x * (5 * dude_perk(PERK_swift_learner))) / 100)) + g_mstr(11))
