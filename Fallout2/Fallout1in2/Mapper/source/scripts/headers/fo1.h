...
#define fo1in2_fo2_wm_enabled           (global_var(GVAR_ENABLE_FO2_WORLDMAP) > 0)
...
#define ce_enabled                      (metarule_exist("opcode_exists") == true andAlso opcode_exists(0x823B) == false)
#define ce_disabled                     (metarule_exist("opcode_exists") == false orElse opcode_exists(0x823B) == true)
