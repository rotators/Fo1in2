...
#define __sfall_expand(x)                          x
#define __sfall_prefix(...)                        0,__VA_ARGS__
#define __sfall_lastof(x,a,b,c,d,e,f,g,h,i,j,...)  j
#define __sfall_cntarg(...)                        __sfall_expand(__sfall_lastof(__VA_ARGS__,8,7,6,5,4,3,2,1,0,0))
...
// automagically counts number of arguments and selects matching sfall_funcX
