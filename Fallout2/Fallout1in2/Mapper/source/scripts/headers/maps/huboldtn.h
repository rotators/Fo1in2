...
#define MVAR_Total_Captors       (0)
#define MVAR_Leave_Thieves       (1)
#define MVAR_Know_Jasmine        (2)
#define MVAR_Give_reward         (3)
#define MVAR_JakeDesk            (4)
#define MVAR_JakeDog             (5)
#define MVAR_JakesDoorDestroyed  (6)
#define MVAR_JakesDoorOpen       (7)
#define MVAR_Burglarized         (8)
