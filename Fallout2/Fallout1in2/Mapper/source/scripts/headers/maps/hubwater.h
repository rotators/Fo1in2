...
#define MVAR_JAIN_DISMISSES      (0)  
#define MVAR_WM_WILL_GIVE_JOB    (1)  
#define MVAR_WM_WILL_DEAL_WITH   (2)  
#define MVAR_COUNSELOR_SUMMONED  (3)  
#define MVAR_DOOR_UNLOCK_FAILED  (4)  
#define MVAR_GUARD_DEAD          (5)  
#define MVAR_CHILDREN_ANGRY      (6)  
#define MVAR_Invasion            (7) // Has this map been invaded by Super Mutants?
