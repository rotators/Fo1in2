...
#define MVAR_IsMommyDead          (0) //  Is the Mommy Deathclaw dead or alive.
#define MVAR_RoamingCount         (1) //  How many roamers are there currently.
#define MVAR_EggCount             (2) //  The number of Deathclaw eggs.
#define MVAR_NewCount             (3) //  The number of new roaming.
#define MVAR_Fixt_PLACEHOLDER_0   (4) //   Adding for ass-covering and future-proofing
#define MVAR_Fixt_PLACEHOLDER_1   (5) //   Adding for ass-covering and future-proofing
